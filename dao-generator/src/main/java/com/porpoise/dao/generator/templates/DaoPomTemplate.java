...
public class DaoPomTemplate implements IGenerator
{
  ...
  protected final String TEXT_5 = "</name>" + NL + "\t<properties>" + NL + "\t\t<javaDocVersion>2.5</javaDocVersion>" + NL + "\t\t<findbugsVersion>2.0.1</findbugsVersion>" + NL + "\t</properties>" + NL + "" + NL + "\t<dependencies>" + NL + "\t\t<dependency>" + NL + "\t\t\t<groupId>com.porpoise.dao</groupId>" + NL + "\t\t\t<artifactId>dao-common</artifactId>" + NL + "\t      <version>0.0.1-SNAPSHOT</version>" + NL + "\t\t</dependency>";
