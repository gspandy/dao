...
public class PropertiesReaderTest
{
    ...
    /**
     * test PropertiesReader can find a properties file that should be on the
     * classpath
     */
    @Test
    public void test_findPropertiesOnClasspath()
    {
        ...
        Assert.assertNotNull(String.format("%s should've been on the classpath for this test to work",
                expectedResourceName), props);
    }

    /**
     * test PropertiesReader does NOT find a properties file not on the
