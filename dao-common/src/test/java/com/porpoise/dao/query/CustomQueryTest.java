...
/**
 * CustomQueryTest created: Jul 27, 2010
 * 
 * @author Aaron * Tests for the {@link CustomQueryImpl} class
 */
public class CustomQueryTest
{
    private static class TestTransaction implements IDbTransaction
    {
        ...
        public <T extends IResultSetVisitor> T executeQuery(final T visitor, final String sql, final Object... params) throws DbException
        {
        ...
        public void executeUpdate(@SuppressWarnings("unused") final String sql, @SuppressWarnings("unused") final Object... args)
        {
    ...
    /**
     * test the orderByKey method, assuring keys are put in the correct order by occurrence in the query string
     */
    @Test
    ...
    public void test_customQueryReplacesMultipleParameters()
    {
        ...
        final TestTransaction transaction = new TestTransaction("i > ? and name like ? and a != ?", "one", "aaron", "one");
