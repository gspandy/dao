 ...
 * *
 * <p>
 * This class provides methods to check for common SQL errors.
 * It may be subclassed by other vendor-specific classes so as to
 * work with various error codes, providing clients of this class
 * with a consistent, vendor-agnostic view.  
 * </p>
 */
public class DbErrorCode
{
     ...
     *
     * @param exception the exception used to initialise this error code
     */
    public DbErrorCode(final DbException exception)
    {
        this.exp = Validation.notNull(exception);
    }
