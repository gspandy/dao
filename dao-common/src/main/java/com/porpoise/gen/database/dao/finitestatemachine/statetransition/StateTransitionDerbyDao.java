...
/**
 * StateTransitionDerbyDao
 * 
 * created: Jul 27, 2010
 * @author Aaron
 * */
class StateTransitionDerbyDao extends AbstractStateTransitionDao
{
    public StateTransitionDerbyDao()
    {
        super();
    }

    public StateTransitionDerbyDao(final StateTransition stateTransition, 
    ...
    public StateTransitionDerbyDao(final Long id)
    {
        super(id);
    }
