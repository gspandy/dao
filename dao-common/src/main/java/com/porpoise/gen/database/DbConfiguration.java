 ...
 * </p>
 * <p>
 * If any new configuration keys are added to a property file, then they should
 * be included here so they can be referenced safely.
 * </p>
 * <p>
 * This class will be initialised the first time a property's value is accessed
 * via {@link getValue}.
 * </p>
 */
public enum DbConfiguration
{
    ...
    /**
     * System property which, when set, specifies the database property file
     * location. The classpath will first be searched, followed by the file
     * system if it is an absolute location.
     */
    public static final String      SYSTEM_PROPERTY_CONFIG_LOCATION = "com.porpoise.gen.aaron.config";
    /**
     * The default property file to use when the
     * {@link #SYSTEM_PROPERTY_CONFIG_LOCATION} is not set
     */
    ...
    /**
     * <p>
     * initialise the configuration. If not called explicitly this method will
     * be called the first time a configuration property is accessed.
     * </p>
     * <p>
     * Multiple calls will force reinitialisation, potentially reloaded previous
     * property values
     * </p>
     */
    ...
    /**
     * return the configuration value. If this is the first call to retrieve a
     * property then the DatabaseConfiguration will attempt to initialize all
     * properties based on the configuration file.
     * 
    ...
    /**
     * load the configuration from either the default properties file or the
     * properties file as specified by {@code SYSTEM_PROPERTY_CONFIG_LOCATION}
     * 
     ...
     *            the string used to denote where to find the properties from
    ...
    public static Properties loadProperties(final String systemProperty, final String defaultLocation)
    {
        ...
        if (properties == null)
        {
            throw new IllegalStateException(String.format(
                    "Couldn't find properties '%s' on the classpath or file system. "
