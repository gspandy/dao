 ...
 * @author Aaron
 * */
class StateNodeDerbyDao extends AbstractStateNodeDao
{
    public StateNodeDerbyDao()
    {
        super();
    }

    public StateNodeDerbyDao(final StateNode stateNode, 
    ...
    public StateNodeDerbyDao(final Long id)
    {
        super(id);
    }
