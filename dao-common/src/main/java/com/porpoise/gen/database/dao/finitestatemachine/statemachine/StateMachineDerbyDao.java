...
/**
 * StateMachineDerbyDao
 * 
 * created: Jul 27, 2010
 * @author Aaron
 * */
class StateMachineDerbyDao extends AbstractStateMachineDao
{
    public StateMachineDerbyDao()
    {
        super();
    }

    public StateMachineDerbyDao(final StateMachine stateMachine
     )
    {
        super(stateMachine
         );
    ...
    public StateMachineDerbyDao(final Long id)
    {
        super(id);
    }
