 ...
 *         </p>
 *         <p>
 *         The preferred access to a database is via an IDbTransaction, however, as that guarantees connections will be
 *         properly closed after use.
 *         </p>
 *         <p>
 *         Also, though the DbConnectionFactory is a singleton, classes should still require if possible for
 *         DbConnectionFactory instances to be passed in so as not to abuse this fact.
 *         </p>
 *         <p>
 *         A DbConnectionFactory will need to have datasources registered with it, and the preferred method of doing so
 *         is via an {@link IDatabaseVendor}. IDatabaseType implementations are available via the {@link Databases}
 *         object.
 *         </p>
 *         <p>
...
public enum DbConnectionFactory
{
	...
	/**
	 * <p>
	 * Return the singleton factory instance. This usage is discouraged, however, as clients of the DbConnectionFactory
	 * should advertise their dependence on it through their API.
	 * </p>
	 * <p>
	...
	/**
	 * register a datasource with the connection factory. If no default datasources have been registered, then this
	 * datasource will be used as the default.
	 * 
	 * @param key
	...
	/**
	 * convenience method for single-use queries to save the user having to always run queries within a try/finally
	 * block
	 * 
	 * @param <T>
	 *            the visitor type
