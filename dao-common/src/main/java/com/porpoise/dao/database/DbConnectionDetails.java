...
/**
 * DbConnectionDetails created: Jul 27, 2010
 * 
 * @author Aaron *
 *         <p>
 *         The DbConnectionDetails class encapsulates the data contained in {@link DbConfiguration}. This bean copy of the
 *         DatabaseConfiguration enumeration exists to allow other.
 *         </p>
 */
public class DbConnectionDetails
{
    ...
    /**
     * @param value
     *            The database vendor. This should be a valid Databases enumeration string value.
     */
    ...
    {
        if (Strings.isNullOrEmpty(getVendor()))
        {
